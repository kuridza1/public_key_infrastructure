...
import { CertificateTemplateListComponent } from './components/certificate-template/certificate-template-list/certificate-template-list.component';
...
export const routes: Routes = [
  ...
  // EeUser
  {
    ...
    data: { roles: ['EeUser', 'CaUser'] as Role[] },
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard, roleGuard],
    data: { roles: ['CaUser', 'Admin'] as Role[] },
  },
